import type {
  ...
  Person, CategoryForward, Envelope, CustomRule, Holding,
} from './types';
...
class BudgetDb {
  ...
  envelopes        = new ApiTable<Envelope>('envelopes');
  customRules      = new ApiTable<CustomRule>('custom-rules');
  holdings         = new ApiTable<Holding>('holdings');
